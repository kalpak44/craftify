    ...
    const features = [
        {
            ...
            description: "Track stock, bins, lots with real-time availability & low-stock alerts.",
            icon: (
        ...
        },
        {
            ...
            description: "Define BOMs, explode components, and issue work orders in a click.",
            icon: (
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
        ...
        },
        {
            ...
            description: "Log operations, yield, and scrap from tablets on the shop floor.",
            icon: (
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
        ...
        },
        {
            ...
            description: "Reorder suggestions, PO approvals, and barcode receiving.",
            icon: (
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
        ...
        },
        {
            ...
            description: "Trigger flows when forms submit: allocate parts, post entries, notify teams.",
            icon: (
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
        ...
        },
        {
            ...
            description: "Visualize throughput, OTIF, and inventory turns with simple widgets.",
            icon: (
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
        ...
        <div
            ...
            <header className="mx-auto max-w-6xl px-4 pt-14 pb-10 text-center">
                ...
                <p className="mt-4 text-base md:text-lg text-gray-400 max-w-2xl mx-auto">
                    Craftify keeps your stock, BOMs, and shop-floor operations in sync—without the complexity. Forms in,
                    logic runs, clean APIs out.
                </p>
                {!isAuthenticated && (
                    <div className="mt-6 flex items-center justify-center gap-3">
                        <button onClick={() => loginWithRedirect()}
                                className="rounded-2xl px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white text-base">Get
                            started free
                        </button>
                        <button onClick={() => loginWithRedirect({screen_hint: "signup"})}
                                className="rounded-2xl px-6 py-3 bg-gray-800 hover:bg-gray-700 border border-white/10 text-base">Create
                            an account
                        </button>
                    </div>
                )}
                    ...
                    {features.map((f) => (
                        <div key={f.title}
                            ...
                            <div className="flex items-center gap-3 pb-2">
                                <div className="p-2 rounded-xl bg-gray-800 text-white">{f.icon}</div>
            ...
            <section className="mx-auto max-w-6xl px-4 pb-20">
                <div
                    ...
                    <h2 className="text-2xl md:text-3xl font-semibold text-white">Ship your first work order in
                        minutes</h2>
                    <p className="mt-2 text-gray-400 max-w-3xl mx-auto">Start with a CSV of items, add a BOM, and go
                        from quote to shipment.</p>
                    <div className="mt-6 flex items-center justify-center gap-3">
                        <a href="/getting-started"
                           className="rounded-2xl px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white">Open Getting
                            Started</a>
                    </div>
                </div>
            </section>
