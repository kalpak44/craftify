...
public interface ItemsApi {
  ...
  default ResponseEntity<ItemPage> itemsGet(
      ...
      @Parameter(name = "status", description = "", in = ParameterIn.QUERY)
          ...
          @Nullable
          Status status,
      @Parameter(name = "categoryId", description = "", in = ParameterIn.QUERY)
          @Valid
      ...
      @Size(min = 1, max = 16)
          @Parameter(
              ...
              in = ParameterIn.QUERY)
          @Valid
          @RequestParam(value = "uom", required = false)
          @Nullable
          String uom,
      @Parameter(name = "includeDeleted", description = "", in = ParameterIn.QUERY)
          @Valid
   ...
   *     Details (RFC-7807) (status code 412)
   */
  @Operation(
      ...
      responses = {
        @ApiResponse(
            ...
            content = {
              @Content(
                  mediaType = "application/json",
                  schema = @Schema(implementation = ItemDetail.class)),
              @Content(
                  mediaType = "application/problem+json",
                  schema = @Schema(implementation = ItemDetail.class))
            }),
   ...
   * @return Updated (status code 200) or Problem Details (RFC-7807) (status code 400) or Problem
   *     Details (RFC-7807) (status code 404) or Problem Details (RFC-7807) (status code 412)
   */
  @Operation(
  ...
  default ResponseEntity<ItemDetail> itemsIdPut(
      ...
      @NotNull
          ...
          @RequestHeader(value = "If-Match", required = true)
          String ifMatch,
      @Parameter(name = "UpdateItemRequest", description = "", required = true) @Valid @RequestBody
  ...
  default ResponseEntity<ItemDetail> itemsPost(
      @Parameter(name = "CreateItemRequest", description = "", required = true) @Valid @RequestBody
