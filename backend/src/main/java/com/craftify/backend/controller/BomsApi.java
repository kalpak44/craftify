...
public interface BomsApi {
        ...
        @ApiResponse(
            ...
            content = {
              @Content(
                  ...
                  schema = @Schema(implementation = BomPage.class))
            })
      },
  ...
  default ResponseEntity<BomPage> bomsGet(
      ...
      @Min(1)
          ...
          Integer size,
      @Parameter(name = "sort", description = "e.g. productName,asc", in = ParameterIn.QUERY)
          @Valid
          @RequestParam(value = "sort", required = false)
          @Nullable
          String sort,
      @Parameter(name = "q", description = "Search by id or product name", in = ParameterIn.QUERY)
          @Valid
      ...
      responses = {
        @ApiResponse(
            ...
            content = {
              @Content(
                  mediaType = "application/json",
                  schema = @Schema(implementation = BomDetail.class))
            }),
  ...
  @RequestMapping(
      ...
      value = PATH_BOMS_ID,
      produces = {"application/json"})
  default ResponseEntity<BomDetail> bomsIdGet(
      @Parameter(in = ParameterIn.PATH, name = "id") @PathVariable("id") String id) {
    return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
  }
  ...
  default ResponseEntity<BomDetail> bomsPost(
      @Valid @RequestBody(required = false) BomDetail createRequest) {
    return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
  }
  ...
  @RequestMapping(
      ...
      produces = {"application/json"},
      consumes = {"application/json"})
  default ResponseEntity<BomDetail> bomsIdPut(
      @Parameter(in = ParameterIn.PATH, name = "id") @PathVariable("id") String id,
  ...
  default ResponseEntity<Void> bomsIdDelete(
      @Parameter(in = ParameterIn.PATH, name = "id") @PathVariable("id") String id,
      @RequestHeader(value = "If-Match", required = false) String ifMatch) {
    return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
  }
