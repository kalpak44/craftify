...
public class BomList implements Serializable {
  ...
  public BomList productId(String productId) {
  ...
  public BomList productName(String productName) {
  ...
  public BomList revision(String revision) {
  ...
  public BomList status(BomStatus status) {
    this.status = status;
    return this;
  }
  ...
  public BomList updatedAt(@Nullable OffsetDateTime updatedAt) {
  ...
  public BomList componentsCount(Integer componentsCount) {
